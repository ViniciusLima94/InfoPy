...
def KernelEstimatorTE(x, y, bw = 0.3, kernel = 'tophat', norm=True):
	r'''
...
def kde_sklearn(x, x_grid, bandwidth=0.2, **kwargs):
    ...
    kde_skl = KernelDensity(bandwidth=bandwidth,metric='chebyshev',algorithm='kd_tree', **kwargs)
